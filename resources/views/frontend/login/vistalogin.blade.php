                ...
                <div class="row">
                    <div class="col-lg-6 col-12 mx-auto">
                        <div class="text-center image-size-small position-relative">
                            <img src="{{ asset('images/logo_dis.png') }}" class="rounded-circle p-2 bg-white">
                        </div>
                        <div class="p-5 bg-white rounded shadow-lg">
                            <h4 class="mb-2 text-center pt-5"><strong>Municipio de Santa Ana Norte</strong></h4>
                            <p class="text-center"><strong>Distrito Metapán</strong></p>
                            <p class="text-center lead">Taller Estructuras Metálicas</p>
                            <form>
                                ...
                                <input type="button" value="Entrar" style="margin-top: 15px" onclick="login()" class="btn btn-dark btn-lg w-100 shadow-lg">
                            </form>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function login() {
        ...
        axios.post('/obradebanco.com/login', formData, {
        })
            .then((response) => {
                closeLoading();
                verificar(response);
